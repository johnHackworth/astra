...
Crafty.c("Particles", {
    ...
    _Particles: {
        ...
        init: function (options) {
            ...
            this.particleOrigin = {
                x: options.particleOriginX || 0,
                y: options.particleOriginY || 0
            }
        },
        ...
        initParticle: function (particle) {
            particle.position.x = Crafty.viewport._scale * (this.position.x + this.particleOrigin.x + this.positionRandom.x * this.RANDM1TO1());
            particle.position.y = Crafty.viewport._scale * (this.position.y + this.particleOrigin.y + this.positionRandom.y * this.RANDM1TO1());
