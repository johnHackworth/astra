...
Crafty.extend({
    ...
    viewport: {
        ...
        zoom: (function () {
            ...
            var startingZoom, finalZoom, finalAmount, startingX, finalX, startingY, finalY, easing, target;
            ...
            function enterFrame(e){
                ...
                if(target) {
                    finalX = target.x- Crafty.viewport.width  / (2 * finalZoom) ;
                    finalY = target.y- Crafty.viewport.height  / (2 * finalZoom) ;
                } else {
